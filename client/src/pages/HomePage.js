    ...
    <div className=" bg-texture w-full h-screen ">
      ...
      <div className="w-6/12 m-36">
        ...
        <p className="m-8 text-blue-200 font-bold text-xl ">
          Suno bhai ye website kisi kaam ki nhi h, pr phir bhi tere pas bohot
          time h, kuch kaam nhi h to aaja, register yourself clicking the button
          below or login using the other button.
        </p>
